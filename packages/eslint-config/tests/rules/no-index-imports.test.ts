...
import { noIndexImports } from '../../src/rules/no-index-imports.js';
...
ruleTester.run('no-index-imports', noIndexImports, {
  ...
  invalid: [
    ...
    // Importing specific file from subdirectory (with autofix)
    {
      code: `import { foo } from './subdir/foo.js';`,
      filename: '/project/src/utils/helper.ts',
      output: `import { foo } from './subdir/index.js';`,
      errors: [
        {
          messageId: 'otherDirectoryNonIndex',
          data: {
