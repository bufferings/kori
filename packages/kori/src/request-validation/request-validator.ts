...
import { type KoriResult, type MaybePromise } from '../utils/index.js';
...
export type KoriRequestValidator<Provider extends KoriSchemaProviderDefault, Schema extends KoriSchemaDefault, ErrorType> = {
